...
plt1grm <- ggplot(head(gr1,100), aes(x=reorder(word, freq), y=freq)) + 
        geom_bar(stat="Identity", fill='red') + xlab("") +
...
SlothKey App first version  
 -first basic version of prediction application
 -tokenize function and profane loading moved to predict.r
 -ngrams database, profanity and predict.r moved to App directory
 -benchmarking gives good results. maybe too good
 -moved quizzes to separate file which is untracked in this repo 
