...
Not removing stopwords anymore
 ...
 -debug.R renamed to train.R
 -added breaking corpus to single sentences
 -not removing stopwords anymore
 -training functions compartmentalized and refactored as much as possible and moved to train.R
 -buildVocabulary and predict use functions from train
 -removed a lot of commented code 
 -dbname is now a parameter
 -data for performance graph is now gathered 
 -added managing of some boundary cases of predict
 -data.dir variable now helps with 'file not found' problem
