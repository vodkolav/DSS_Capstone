...
dbname <- paste(data.dir,"ngrams", sep = "/")
...
vu <- function(x){View(x)} #because reasons
...
sqldf("CREATE UNIQUE INDEX `gram1_w1_index` ON `gram1` (`word1` ASC)", dbname = dbname)
...
```{r}
results <- rbind(results0,results2,results3,results4,results5)
